...
*/
!(function (n, c) {
  void 0 === c && l("Pagination requires jQuery.");
  var r = "pagination",
    s = "__pagination-",
    I =
      (c.fn.pagination &&
      ...
      (c.fn[r] = function (a) {
        if (void 0 !== a) {
          var t,
            u = c(this),
            D = c.extend({}, c.fn[r].defaults, a),
            e = {
              initialize: function () {
                var e,
                  t = this;
                u.data("pagination") || u.data("pagination", {}),
                  !1 !== t.callHook("beforeInit") &&
                    (u.data("pagination").initialized &&
                      c(".paginationjs", u).remove(),
                    (t.disabled = !!D.disabled),
                    (e = t.model =
                      { pageRange: D.pageRange, pageSize: D.pageSize }),
                    t.parseDataSource(D.dataSource, function (a) {
                      (t.isAsync = I.isString(a)),
                        I.isArray(a) &&
                          (e.totalNumber = D.totalNumber = a.length),
                        (t.isDynamicTotalNumber =
                          t.isAsync && D.totalNumberLocator);
                      a = t.render(!0);
                      D.className && a.addClass(D.className),
                        (e.el = a),
                        u["bottom" === D.position ? "append" : "prepend"](a),
                        t.observer(),
                        (u.data("pagination").initialized = !0),
              ...
              render: function (a) {
                var e = this,
                  t = e.model,
                  o = t.el || c('<div class="paginationjs"></div>'),
                  a = !0 !== a,
                  t =
                    (e.callHook("beforeRender", a),
                    t.pageNumber || D.pageNumber),
                  i = D.pageRange || 0,
                  n = e.getTotalPage(),
                  r = t - i,
                  s = t + i;
                return (
                  ...
                  D.hideOnlyOnePage && o[n <= 1 ? "hide" : "show"](),
              ...
              generatePageNumbersHTML: function (a) {
                var e,
                  ...
                  u = D.pageClassName || "",
                  c = D.activeClassName || "",
                  g = D.disableClassName || "";
                if (null === D.pageRange)
                  for (e = 1; e <= o; e++)
                    s +=
                      e == t
                        ? `<li class="${l}-page J-paginationjs-page ${u} ${c}" data-num="${e}"><a>${e}</a></li>`
                        : `<li class="${l}-page J-paginationjs-page ${u}" data-num="${e}">${i(
                            e
                          )}</li>`;
                else {
                  if (n <= 3)
                    ...
                    D.hideFirstOnEllipsisShow ||
                      (s += `<li class="${l}-page ${l}-first J-paginationjs-page ${u}" data-num="1">${i(
                        1
                      )}</li>`),
                  ...
                  if (o - 2 <= r)
                    for (e = r + 1; e <= o; e++)
                      s += `<li class="${l}-page J-paginationjs-page ${u}" data-num="${e}">${i(
                        e
                      )}</li>`;
                  else
                    (s += `<li class="${l}-ellipsis ${g}"><a>${a}</a></li>`),
                      D.hideLastOnEllipsisShow ||
                        (s += `<li class="${l}-page ${l}-last J-paginationjs-page ${u}" data-num="${o}">${i(
                          o
                        )}</li>`);
                }
                return s;
              ...
              generateHTML: function (a) {
                var e,
                  ...
                  T =
                    "function" == typeof D.formatSizeChanger
                      ? D.formatSizeChanger(o, i, r)
                      : D.formatSizeChanger,
                  C =
                    "function" == typeof D.formatNavigator
                      ? D.formatNavigator(o, i, r)
                      : D.formatNavigator,
                  H =
                    "function" == typeof D.formatGoInput
                      ? D.formatGoInput(S, o, i, r)
                      : D.formatGoInput,
                  w =
                    "function" == typeof D.formatGoButton
                      ? D.formatGoButton(v, o, i, r)
                      : D.formatGoButton,
                  O =
                    "function" == typeof D.autoHidePrevious
                      ? D.autoHidePrevious()
                      : D.autoHidePrevious,
                  z =
                    "function" == typeof D.autoHideNext
                      ? D.autoHideNext()
                      : D.autoHideNext,
                  L =
                    "function" == typeof D.header
                      ? D.header(o, i, r)
                      : D.header,
                  J =
                    "function" == typeof D.footer
                      ? D.footer(o, i, r)
                      : D.footer;
                if (
                  (L &&
                  ...
                  g &&
                    C &&
                    (x += `<div class="${N}-nav J-paginationjs-nav">${(e =
                  ...
                  (l || c || u) &&
                    ...
                    l &&
                      (o <= 1
                        ? O ||
                          (x += `<li class="${N}-prev ${y} ${k}"><a>${b}</a></li>`)
                        : (x += `<li class="${N}-prev J-paginationjs-previous ${k}" data-num="${
                            o - 1
                          }" title="Previous page">${n(b)}</li>`)),
                    c && (x += t.generatePageNumbersHTML(a)),
                    u &&
                      (i <= o
                        ? z ||
                          (x += `<li class="${N}-next ${y} ${P}"><a>${h}</a></li>`)
                        : (x += `<li class="${N}-next J-paginationjs-next ${P}" data-num="${
                            o + 1
                ...
                return (
                  d &&
                    H &&
                    (x += `<div class="${N}-go-input">${(e = t.replaceVariables(
                      H,
                      { currentPage: o, totalPage: i, totalNumber: r, input: S }
                    ))}</div>`),
                  m &&
                    w &&
                    (x += `<div class="${N}-go-button">${(e =
              ...
              findTotalNumberFromRemoteResponse: function (a) {
                this.model.totalNumber = D.totalNumberLocator(a);
              },
              go: function (a, t) {
                var e,
                  o,
                ...
                function l(a) {
                  ...
                  !1 !== r.callHook("beforePaging", n) &&
                    ...
                    (u.data("pagination").model = s),
                    D.formatResult &&
                      ((e = c.extend(!0, [], a)),
                      I.isArray((a = D.formatResult(e))) || (a = e)),
                    (u.data("pagination").currentPageData = a),
                    r.doCallback(a, t),
                ...
                r.disabled ||
                  ...
                  0 < o && i < n) ||
                  (r.isAsync
                    ? ((i = (o = D.alias || {}).pageSize || "pageSize"),
                      (o = o.pageNumber || "pageNumber"),
                      ((e = {})[i] = a),
                      (e[o] = n),
                      (i = "function" == typeof D.ajax ? D.ajax() : D.ajax) &&
                        i.pageNumberStartWithZero &&
                        ((e[o] = n - 1), delete i.pageNumberStartWithZero),
                      c.extend(
                        !0,
                        (a = {
                          type: "get",
                      ...
                      (a.success = function (a) {
                        (r.model.originalResponse = a),
                          r.isDynamicTotalNumber
                            ...
                            : (r.model.totalNumber = D.totalNumber),
                          l(r.filterDataWithLocator(a));
                      }),
                      (a.error = function (a, e, t) {
                        D.formatAjaxError && D.formatAjaxError(a, e, t),
                          r.enable();
                      }),
                      r.disable(),
                      D.ajaxFunction ? D.ajaxFunction(a) : c.ajax(a))
                    : l(r.getPagingData(n)));
              },
              doCallback: function (a, e) {
                ...
                "function" == typeof e
                  ? e(a, t)
                  : "function" == typeof D.callback && D.callback(a, t);
              },
              destroy: function () {
                !1 !== this.callHook("beforeDestroy") &&
                  (this.model.el.remove(),
                  u.off(),
                  c("#paginationjs-style").remove(),
              ...
              getTotalNumber: function () {
                return this.model.totalNumber || D.totalNumber || 0;
              },
              getTotalPage: function () {
                return Math.ceil(this.getTotalNumber() / D.pageSize);
              },
              ...
              filterDataWithLocator: function (t) {
                var o,
                  a = this.getLocator(D.locator);
                if (I.isObject(t)) {
                  try {
                    c.each(a.split("."), function (a, e) {
                      o = (o || t)[e];
                    });
                  } catch (a) {}
                  o
              ...
              parseDataSource: function (a, e) {
                var t = this;
                I.isObject(a)
                  ? e((D.dataSource = t.filterDataWithLocator(a)))
                  : I.isArray(a)
                  ? e((D.dataSource = a))
                  : "function" == typeof a
                  ...
                  : "string" == typeof a
                  ? (/^https?|file:/.test(a) && (D.ajaxDataType = "jsonp"),
                    e(a))
                ...
                var o = this,
                  ...
                  a =
                    ...
                    t.on("click", ".J-paginationjs-page", function (a) {
                      ...
                      if (
                        t &&
                        !e.hasClass(D.disableClassName) &&
                        !e.hasClass(D.activeClassName)
                      )
                        return (
                    ...
                    t.on("click", ".J-paginationjs-previous", function (a) {
                      var e = c(a.currentTarget),
                        t = e.attr("data-num").trim();
                      if (t && !e.hasClass(D.disableClassName))
                        return (
                    ...
                    t.on("click", ".J-paginationjs-go-button", function (a) {
                      var e = c(".J-paginationjs-go-pagenumber", t).val();
                    ...
                    t.on(
                      ...
                      function (a) {
                        if (13 === a.which) {
                          var e = c(a.currentTarget).val();
                          if (!1 === o.callHook("beforeGoInputOnEnter", a, e))
                            return !1;
                          u.trigger(s + "go", e),
                            c(".J-paginationjs-go-pagenumber", t).focus(),
                    ...
                    t.on("change", ".J-paginationjs-size-select", function (a) {
                      var e = c(a.currentTarget),
                        e = parseInt(e.val()),
                        t = o.model.pageNumber || D.pageNumber;
                      if ("number" == typeof e)
                        return (
                    ...
                    u.on(s + "previous", function (a, e) {
                      o.previous(e);
                    }),
                    u.on(s + "next", function (a, e) {
                      o.next(e);
                    }),
                    u.on(s + "disable", function () {
                      o.disable();
                    }),
                    u.on(s + "enable", function () {
                      o.enable();
                    }),
                    u.on(s + "refresh", function (a, e) {
                      o.refresh(e);
                    }),
                    u.on(s + "show", function () {
                      o.show();
                    }),
                    u.on(s + "hide", function () {
                      o.hide();
                    }),
                    u.on(s + "destroy", function () {
                      o.destroy();
                    }),
                    Math.max(o.getTotalPage(), 1)),
                  e = D.pageNumber;
                o.isDynamicTotalNumber && D.resetPageNumberOnInit && (e = 1),
                  D.triggerPagingOnInit && u.trigger(s + "go", Math.min(e, a));
              },
            };
          if (u.data("pagination") && !0 === u.data("pagination").initialized) {
            if (g(a))
              return u.trigger.call(this, s + "go", a, arguments[1]), this;
            if ("string" == typeof a) {
              ...
              switch (((o[0] = s + o[0]), a)) {
                ...
                case "hide":
                case "destroy":
                  u.trigger.apply(this, o);
                  break;
                case "getSelectedPageNum":
                case "getCurrentPageNum":
                  return (
                    u.data("pagination").model
                      ? u.data("pagination").model
                      : u.data("pagination").attributes
                  ).pageNumber;
                case "getTotalPage":
                  return Math.ceil(
                    u.data("pagination").model.totalNumber /
                      u.data("pagination").model.pageSize
                  );
                case "getSelectedPageData":
                case "getCurrentPageData":
                  return u.data("pagination").currentPageData;
                case "isDisabled":
                  return !0 === u.data("pagination").model.disabled;
                default:
                  l("Unknown action: " + a);
              }
              return this;
            ...
            (t = u),
              ...
              t.data("pagination", {}),
              c(".paginationjs", t).remove();
          } else I.isObject(a) || l("Illegal options");
          var i = D;
      ...
      (c[r] = function (a, e) {
        ...
        if (
          ...
          (t = "string" != typeof a && a instanceof jQuery ? a : c(a)).length)
        )
  ...
  c.each(["Object", "Array", "String"], function (a, t) {
    I["is" + t] = function (a) {
      return (
        ("object" == (e = typeof (a = a))
          ? null == a
